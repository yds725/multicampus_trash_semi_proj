...
ggplot(data=small_top5_df, aes(x=District, y=Households)) + geom_col( fill = "steelblue") + ggtitle(label = "1인가구 거주 밀집 자치구 TOP5 ")
